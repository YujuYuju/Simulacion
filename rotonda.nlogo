...
to setup
  ...
  [
    ...
    if abs (pxcor) = 10 and (pxcor ^ 2 + pycor ^ 2 > 30 ^ 2)
    [
      set pcolor white
    ]
    if (pxcor) > -129 and pxcor < -107  and (abs (pycor) > 19)
    [
      set pcolor grey
    ]
    if (pxcor) < -131 and pxcor > -153  and (abs (pycor) > 19)
    [
      set pcolor grey
    ]

     if (pxcor) = -117 and (abs (pycor) > 20)
    [
      set pcolor white
    ]

     if (pxcor) = -143 and (abs (pycor) > 20)
    [
      set pcolor white
    ]
    ...
    if abs (pycor) = 9 and (pxcor ^ 2 + pycor ^ 2 > 30 ^ 2)
    [
      set pcolor white
    ]
